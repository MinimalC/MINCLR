...
#define stack_Generic_T0Array(__length,...) { .base = { .base = stack_System_Object(Generic_T0Array), .length = __length, .value = &(Generic_T0 []){ __VA_ARGS__ } } }

__export struct_System_Type  Generic_T0ArrayType;

typedef System_void __delegate(Generic_T0Array_free)(Generic_T0Array that);
typedef System_void __delegate(Generic_T0Array_init)(Generic_T0Array that);
...
#define Generic_T0Array_new  Generic_T0Array_new__00
