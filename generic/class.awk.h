...
typedef __fixed struct_Generic_T0 {
...
typedef Generic_T0 __delegate(Generic_T0_init)(Generic_T0 that);
typedef System_void __delegate(Generic_T0_free)(Generic_T0 that);

#define Generic_T0_new  Generic_T0_new__00

__export Generic_T0  Generic_T0_new();
__export Generic_T0  base_Generic_T0_init(Generic_T0 that);
__export System_void  base_Generic_T0_free(Generic_T0 that);
...
#define __T0_new  Generic_T0_new

#define __T0_init  Generic_T0_init
#define __T0_free  Generic_T0_free
