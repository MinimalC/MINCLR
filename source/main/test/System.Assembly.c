...
literal_string8  sharedObjectName = "/lib/x86_64-linux-gnu/libc.so.6";
#elif defined(have_ARM)
literal_string8  sharedObjectName = "/lib/arm-linux-gnueabihf/libc.so.6";
#endif

literal_string8  symbolName = "malloc";
