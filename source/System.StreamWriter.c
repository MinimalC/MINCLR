...
struct_System_String  STRING_System_StreamWriter = const_System_String("System.StreamWriter");
...
struct_System_Type_FunctionInfo  System_StreamWriterTypeFunctions[] = {
    ...
    [1] = { .base = stack_System_Object(System_Type_FunctionInfo), .function = base_System_Object_free, .value = base_System_StreamWriter_free },
};

struct_System_Type  System_StreamWriterType = { .base = { .Type = __typeof(System_Type) },
    .name = &STRING_System_StreamWriter,
