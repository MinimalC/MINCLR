...
typedef struct System_IntervalTimeSpan {

    struct System_TimeSpan interval;
    struct System_TimeSpan value;

} * System_IntervalTimeSpan;

export struct System_Type  System_IntervalTimeSpanType;
