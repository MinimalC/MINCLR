...
typedef void delegate(System_Dictionary_init)(System_Dictionary that);

export System_Dictionary  new_System_Dictionary();
export void  base_System_Dictionary_init(System_Dictionary that);
