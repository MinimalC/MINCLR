...
export System_Bool  System_Directory_open(System_Directory that, System_String8 directoryName);
...
export System_DirectoryList  System_Directory_list(System_String8 directoryName);
export System_DirectoryList  System_Directory_list__hidden(System_String8 directoryName, System_Bool hidden);
export System_DirectoryList  System_Directory_list__recursive(System_String8 directoryName, System_Bool recursive);
export System_DirectoryList  System_Directory_list__recursive_hidden(System_String8 directoryName, System_Bool recursive, System_Bool hidden);
